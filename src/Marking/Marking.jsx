...
class Marking extends React.Component {
    ...
    loadData = () => {
        ...
        fetch(`${config.apiUrl}/api/marking`, requestOptions)
            ...
            .then(obj => {
                console.log("Submissions: ", obj.body)
                this.setState({
    ...
    render() {
        ...
        //             <td data-label="Lecturer">{submission.lecturerName}</td>
        //             <td data-label="Moderator">{submission.moderatorName}</td>
        //             <td data-label="Created On">{submission.createdOn}</td>
